...
\begin{figure}[h!]
	...
	\label{3.5figb}
	\end{subfigure}\par\medskip
	\caption{Comparison between BuoyantBoussinesqPimpleFoam and mBBPF*}
	\label{3.5fig}
\end{figure}
\newline 
