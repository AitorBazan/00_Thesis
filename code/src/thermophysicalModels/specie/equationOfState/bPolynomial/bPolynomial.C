...
bPolynomial<Specie, PolySize>::bPolynomial(const dictionary& dict)
:
    Specie(dict),
...
template<class Specie, int PolySize>
void bPolynomial<Specie, PolySize>::write(Ostream& os) const
{
    Specie::write(os);
...
template<class Specie, int PolySize>
Ostream& operator<<(Ostream& os, const bPolynomial<Specie, PolySize>& ip)
{
    ip.write(os);
    return os;
}
