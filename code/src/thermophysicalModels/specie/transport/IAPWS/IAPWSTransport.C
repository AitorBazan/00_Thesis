...
Foam::IAPWSTransport<Thermo, PolySize>::IAPWSTransport
(
...
template<class Thermo, int PolySize>
void Foam::IAPWSTransport<Thermo, PolySize>::write(Ostream& os) const
{
...
(
    Ostream& os,
    const IAPWSTransport<Thermo, PolySize>& pt
)
{
    pt.write(os);
    return os;
